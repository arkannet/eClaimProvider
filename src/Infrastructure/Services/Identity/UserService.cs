...
using AutoMapper;
using eClaimProvider.Application.Exceptions;
using eClaimProvider.Application.Extensions;
...
using eClaimProvider.Infrastructure.Specifications;
using eClaimProvider.Shared.Constants.Role;
...
namespace eClaimProvider.Infrastructure.Services.Identity
{
