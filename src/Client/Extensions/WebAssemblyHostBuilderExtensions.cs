...
using eClaimProvider.Client.Infrastructure.Authentication;
using eClaimProvider.Client.Infrastructure.Managers;
using eClaimProvider.Client.Infrastructure.Managers.Preferences;
...
using eClaimProvider.Client.Infrastructure.Managers.ExtendedAttribute;
using eClaimProvider.Domain.Entities.ExtendedAttributes;
using eClaimProvider.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace eClaimProvider.Client.Extensions
{
