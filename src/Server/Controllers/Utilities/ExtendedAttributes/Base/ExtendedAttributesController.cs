...
using eClaimProvider.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace eClaimProvider.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
